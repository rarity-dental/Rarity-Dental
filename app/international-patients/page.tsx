...
import { getInternationalPatientsPage } from "@/sanity/sanity.query";
import { notFound } from "next/navigation";

import { Team } from "@/components/team";
import { getIPMetadata } from "@/sanity/sanity.query";
import { ConsultationForm } from "@/components/forms/connect-form";
import { FlipCard } from "@/components/flip-card/flip-cards";
import StepBlock from "@/components/step-block/step-block";
	...
	return (
		<div
			...
			<div className="md:min-h-[97vh] 2xl:min-h-[80vh] w-full relative flex justify-center items-center">
				...
				<div className="max-w-[300px] md:max-w-7xl mx-auto flex flex-col justify-between space-y-8 items-center h-full z-[2] py-[8%] md:py-[5%]">
			...
			<div className="w-full flex flex-col space-y-4 max-w-[300px] md:max-w-7xl mx-auto py-[8%] md:py-[3%]">
				...
				<p className="text-md md:text-lg pb-4 md:pb-0 text-center md:text-left">
					{data.howWeWork?.description}
				</p>
				<div className="max-w-[300px] md:max-w-7xl mx-auto flex flex-col w-full">
			...
			<div className="w-full">
				<div className="w-full max-w-[300px] md:max-w-7xl mx-auto py-[8%] md:py-[3%] flex flex-col md:flex-row justify-between md:items-start space-y-8 md:space-x-8 min-h-[80vh]">
					...
					<div className="w-full md:w-1/2 lg:min-h-[90vh] 2xl:min-h-[60vh] relative flex items-start justify-start border-2 border-copyColor">
						<img
				...
				<div className="w-full">
					<div className="w-full max-w-[300px] md:max-w-7xl mx-auto py-[3%] flex flex-col justify-center items-center space-y-4">
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4  lg:gap-12 w-full pt-4">
							{blogItems.map((item) => (
								<Link
									href={`/blog/international-patients/${item.slug}`}
									key={item._id}
