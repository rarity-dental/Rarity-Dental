...
// 		text: "Gain insight into the various factors influencing smile design costs in Delhi NCR, from treatment type to advanced technology used, helping you make well- informed decisions about investing in your ideal smile.",
	...
	return (
		<div
			...
			<div className=" w-full flex flex-col justify-center items-center gap-8  py-8 md:py-0 md:pb-[10%] xl:pb-[6%] 2xl:pb-[3%] ">
				<div className="max-w-[320px] sm:max-w-[85%] md:max-w-2xl lg:max-w-6xl lg:px-2 2xl:max-w-7xl mx-auto flex flex-col lg:flex-row lg:justify-between items-center lg:items-start lg:h-[70vh] lg:max-h-[700px] xl:h-[80vh] gap-8 h-full overflow-hidden px-4 md:px-2 xl:px-0">
					<img
			...
			<div className="w-full flex flex-col space-y-4 max-w-[320px	] md:max-w-7xl mx-auto py-[8%] md:py-[3%]">
				<p className="text-sm md:text-md tracking-widest leading-relaxed font-semibold uppercase font-poppins">
					How We Work
				</p>
				...
				<div className="w-full max-w-[342px] md:max-w-7xl mx-auto pt-[3%] md:py-[3%] flex flex-col md:flex-row gap-[5%]">
					<div className="w-full md:w-1/2 h-[600px] z-[3]">
						<img
							...
							alt={`Smile Designing - ${data?.title}`}
							width={300}
							height={300}
