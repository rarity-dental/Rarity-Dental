...
export async function generateMetadata() {
	return await getCategoryMetadata("single-day-dentistry");
}

export default async function SingleDayDentistryPage() {
	const data = await getCategoryStandalonePage("single-day-dentistry");
					...
					<div className="w-full max-w-[320px] md:max-w-7xl mx-auto py-[3%] flex flex-col justify-center items-center space-y-4 px-2">
						<div className="w-full max-w-[300px] md:max-w-7xl mx-auto py-[3%] flex flex-col justify-center items-center space-y-4">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-4  lg:gap-12 w-full pt-4">
								{blogItems.map((item) => (
									<Link
										href={`/blog/single-day-dentistry/${item.slug}`}
										key={item.slug}
